...
\end{equation}
Предполагая, что правая часть зависит только от $\Delta u^k(x',y')$, аппроксимируем значения функции $u$ в точках $(x,y)$ ее значением в точке $(x',y')$, т.е. заменим  
%Заменяя 
...
heading=subbibliography,
keyword=scopus,
title={Публикации, индексированные в Scopus}
]
\printbibliography[
heading=subbibliography,
keyword=nohac,
