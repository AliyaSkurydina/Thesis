...
$$
Перейдем к исследованию процесса $\eqref{equ_rmn}$. Пусть выполнены следующие условия в шаре $S(u^0, r)$, $\|u^0-u_\alpha\| \le r$:
...
\begin{theorem}\label{teo3.1}
	...
	\alpha \le \bar\alpha, \quad r\le \alpha/8N_2, \quad \bar\alpha \ge N_1.
	\end{equation}
