...
\begin{figure}
	...
	\label{fig:mmn_ch1}
\end{figure}
Ниже показаны результаты расчетов методами $\eqref{equ_rmn}$, $\eqref{equ_alphaproc}$, $\Delta$ --- относительная норма невязки. 
\begin{table}[]
	\centering
	...
	\begin{tabular}{|l|c|c|c|}
		\hline
		Метод                            & \multicolumn{1}{l|}{Параметр шага, $\gamma$}                                                                   & \multicolumn{1}{l|}{$\Delta$} & \multicolumn{1}{l|}{Число итераций, $N$} \\ \hline
		ММО                              & \begin{tabular}[c]{@{}c@{}}0.5 (при $\gamma$ = 1 не\\   сходится)\end{tabular}                                       & 0.003                                   & 25                                     \\ \hline
		...
		РМН модиф.                       & \begin{tabular}[c]{@{}c@{}}0.75 (при $\gamma$ = 1 не \\ сходится)\end{tabular}                                       & 0.003                                   & 6                                      \\ \hline
	\end{tabular}
\end{table}
